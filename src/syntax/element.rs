...
use crate::{
    cursor,
    syntax::{Language, node::SyntaxNode, token::SyntaxToken, trivia::SyntaxTrivia},
...
impl<L: Language> From<SyntaxElement<L>> for cursor::element::SyntaxElement {
    fn from(value: SyntaxElement<L>) -> Self {
        match value {
